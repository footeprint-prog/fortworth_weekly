...
const makeLead = (id: string, price: number, kitchen: Lead['kitchen'] = 'full'): Lead => ({
  id, title: id, area: 'Area', propertyType: 'Studio', privacy: 'entire-unit', monthlyRent: price,
  ...
  commuteMinutes: 20, contactName: '', contactMethod: '', phone: '', email: '', sourceName: '', sourceUrl: '', lastChecked: '2026-07-17',
